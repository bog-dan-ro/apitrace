...
void MainWindow::pullTrace()
{
    ...
    if (AndroidUtils().updateFile(localFile, androidFile, AndroidUtils::PullFromDeviceToLocal)) {
...
void MainWindow::pushTrace()
{
    ...
    if (AndroidUtils().updateFile(localFile, androidFile, AndroidUtils::PushLocalToDevice)) {
        m_androidFilePath = androidFile;
        linkLocalAndroidTrace(localFile, androidFile);
    } else {
        QMessageBox::warning(this, tr("Error"),
